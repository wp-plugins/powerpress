	...
	<div id="powerpress_podcast_edit_<?php echo $FeedSlug; ?>">
		...
		<div class="powerpress_row">
			...
			<div class="powerpress_row_content">
				...
				<a href="<?php echo admin_url(); ?>?action=powerpress-jquery-media&podcast-feed=<?php echo $FeedSlug; ?>&KeepThis=true&TB_iframe=true&modal=true" title="Browse Media Files" class="thickbox"><img src="<?php echo powerpress_get_root_url(); ?>/images/folder.png" alt="Browse Media Files" /></a>
