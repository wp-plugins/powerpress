...
* Retored m4a default player through quicktime embed for m4a files with chapter info. To play m4a with FlowPlayerClassic/HTML5, go to PowerPress Settings > Appearance tab.
