...
* Better detection used when server does not support HTTP URL connections, display message when `allow_url_fopen` setting is disabled and cURL library not available.
