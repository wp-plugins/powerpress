...
Fixed powerpress_bloginfo_rss() warning message that occurred for some ussers, Updated the itunes_url setting to handle the latest itunes URL itunes.apple.com, No longer including revision posts in the PodPress import episode utility, 
